...
export const RC = {
	...
	"You can use this feature a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.": "你可以使用此特性的次數等同於你的熟練加值，並在完成長休時恢復所有已消耗的使用次數。",
	"You can use this feature a number of times equal to your proficiency bonus, and you regain all expended uses of it when you finish a long rest.": "你可以使用此特性的次數等同於你的熟練加值，並在完成長休時恢復所有已消耗的使用次數。",
	"Once you use this feature, you can't use it again until you finish a long rest.": "使用此特性後，直到你完成長休前都無法再次使用。",
	"Once you use this feature, you can't use it again until you finish a short or long rest.": "使用此特性後，直到你完成短休或長休前都無法再次使用。",
