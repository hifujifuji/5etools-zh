...
{2: "{@skill Intimidation}、{@skill Persuasion}", 6: `${INK}、一本詩集、一套校服，以及一個裝有 15 gp 的{@item pouch|phb}`,
 ...
 25: "許多吟遊詩人在銀羽找到歸屬，將他們聲音的力量運用在銀羽魔法上。法師（特別是研習{@class Wizard|PHB|Illusion|幻術|PHB}與{@class Wizard|PHB|Enchantment|惑控|PHB}學派的法師）在銀羽很常見，契術師也是。{@class Cleric|PHB|Light|光明|PHB}與{@class Cleric|PHB|Trickery|詭術|PHB}領域的牧師也能很好地融入銀羽的法師之中。",
...
{2: "{@skill Nature}、{@skill Survival}", 7: `${INK}、一本植物鑑定書、一個{@item iron pot|PHB}、一個{@item herbalism kit|PHB}、一套校服，以及一個裝有 15 gp 的{@item pouch|phb}`,
 ...
 26: "德魯伊與契術師構成了凋花學生群體的大多數。少數法師（大多是研習{@class Wizard|PHB|School of Necromancy|死靈|PHB}學派的法師）與牧師（包括{@class Cleric|PHB|Life|生命|PHB}或{@class Cleric|PHB|Nature|自然|PHB}領域的牧師）也在凋花找到歸屬。",
